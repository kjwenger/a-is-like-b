  ...
  body
    ...
    .section
      ...
      .case (.name "Type Coercion") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/type-coercion.go)
      ...
      .case (.name "String Interpolation") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/string-interpolation.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Range Operator") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/range-operator.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Inclusive Range Operator") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/inclusive-range-operator.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
    ...
    .section
      ...
      .case (.name "Arrays") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/arrays.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Maps") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/maps.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Empty Collections") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/empty-collections.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
    ...
    .section
      ...
      .case (.name "Functions") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/functions.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Tuple Return") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/tuple-return.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Variable Number Of Arguments") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/variable-number-of-arguments.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Function Type") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/function-type.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Map") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/map.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Sort") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/sort.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Named Arguments") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/named-arguments.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
    ...
    .section
      ...
      .case (.name "Declaration") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/declaration.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Usage") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/usage.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Subclass") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/subclass.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Checking Type") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/checking-type.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Pattern Matching") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/pattern-matching.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Downcasting") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/downcasting.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Protocol") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/protocol.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
      ...
      .case (.name "Extensions") $ .pair
        ...
        .card.elixir (.lang Elixir) $ pre.code $ code (@insert ../code/todo.ex)
        .card.erlang (.lang Erlang) $ pre.code $ code (@insert ../code/todo.erl)
        .card.go (.lang Go) $ pre.code $ code (@insert ../code/extensions.go)
        .card.java (.lang Java) $ pre.code $ code (@insert ../code/todo.java)
        .card.javascript (.lang JavaScript) $ pre.code $ code (@insert ../code/todo.js)
